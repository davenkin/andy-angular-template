...
export const primengSemantic: LaraBaseTokenSections.Semantic = {
  ...
  colorScheme: {
    light: {
      ...
      formField: {
        ...
        invalidBorderColor: 'var(--error-red-color)',
        color: 'var(--text-primary-color)',
        disabledColor: '{surface.500}',
        placeholderColor: 'var(--text-light-color)',
        invalidPlaceholderColor: 'var(--error-red-color)',
      ...
      content: {
        ...
        borderColor: 'var(--line-primary-color)',
        color: '{text.color}',
