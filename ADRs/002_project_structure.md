...
- `common`: contains everything that are common to the whole application, such as common APIs, shared components and global CSS styles.
...
- `common`: contains commonly used files across the whole application
  ...
  - `style`: global/shared styles, also contains PrimeNG theme definition
  - `utils`: common utils
